...
public class HeadBodyRig : MonoBehaviour
{
    ...
    public bool HasSpineIKTarget = false;
    ...
    void Start()
    {
        ...
        {
            offset = SpineIKTarget.transform.position - headConstraint.position;
        }
    }
    ...
    void FixedUpdate()
    {
        ...
        {
            SpineIKTarget.transform.position = headConstraint.position + offset;
        }
